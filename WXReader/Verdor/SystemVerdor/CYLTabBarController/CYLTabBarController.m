...
- (void)addOneChildViewController:(UIViewController *)viewController
    ...
    if (normalImageInfo) {
        viewController.tabBarItem.image = [[self getImageFromImageInfo:normalImageInfo] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    }
    if (selectedImageInfo) {
        viewController.tabBarItem.selectedImage = [[self getImageFromImageInfo:selectedImageInfo] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    }
