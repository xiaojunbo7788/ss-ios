...
- (void)setTitleWithSkipType:(SkipType)skipType duration:(NSInteger)duration{
    ...
    switch (skipType) {
        ...
        case SkipTypeTime:{
            self.hidden = NO;
            self.timeLab.text = [NSString stringWithFormat:@"%@ %@", [WXYZ_UtilsHelper formatStringWithInteger:duration], DurationUnit];
        }
            break;
        case SkipTypeText:{
            self.hidden = NO;
        ...
        case SkipTypeTimeText:{
            self.hidden = NO;
            self.timeLab.text = [NSString stringWithFormat:@"%@ %@", [WXYZ_UtilsHelper formatStringWithInteger:duration], SkipTitle];
        }
            break;
        case SkipTypeRoundTime:{
            self.hidden = NO;
