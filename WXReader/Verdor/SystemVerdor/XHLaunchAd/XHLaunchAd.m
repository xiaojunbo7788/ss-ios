...
@property (nonatomic, copy) NSString __block *enterBackgroundTime; // 进入后台时间戳
@end
...
-(void)setupLaunchAdEnterForeground{
    ...
    switch (_launchAdType) {
        case XHLaunchAdTypeImage:{
            if ((_imageAdConfiguration.showEnterForeground || !_detailPageShowing) && enterInterval >= WX_Launch_Interval) {
                [self setupLaunchAd];
