...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event {
    ...
    if ([view.superview isMemberOfClass:NSClassFromString(@"WXYZ_BookDownloadManagementTableViewCell")]
        || [view.superview isMemberOfClass:NSClassFromString(@"WXYZ_ComicDownloadManagementTableViewCell")]
        || [view.superview isMemberOfClass:NSClassFromString(@"WXYZ_HistoryTableViewCell")]
        || [view.superview isMemberOfClass:NSClassFromString(@"WXYZ_AudioDownloadCacheTableViewCell")]
        || [view.superview isMemberOfClass:NSClassFromString(@"WXYZ_BookMarkCell")]){
