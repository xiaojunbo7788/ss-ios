...
@interface WXYZ_LoadingBubbles()<CAAnimationDelegate>
...
@implementation WXYZ_LoadingBubbles
...
- (void)removeACircle
{
    if (self.circlesArr.count > 0) {
        ...
        [UIView animateWithDuration:0 animations:^{
            ...
            rect.origin.y = self.isHeader?-80:80;
            circle.frame = rect;
        } completion:^(BOOL finished) {
...
{
    radius = radius;
    UIView *circle = [[UIView alloc] initWithFrame:CGRectMake(x, self.isHeader?-80:80, radius * 2, radius * 2)];
