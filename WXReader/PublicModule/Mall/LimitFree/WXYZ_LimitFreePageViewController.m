//
//  WXYZ_LimitFreePageViewController.m
//  WXReader
//
...
@interface WXYZ_LimitFreePageViewController () <UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, assign) BOOL needRefresh;

@end

@implementation WXYZ_LimitFreePageViewController
